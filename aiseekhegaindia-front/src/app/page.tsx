        ...
        <div className={styles.heroContent}>
          <div className={styles.heroLeft}>
            ...
            <div className={styles.buttons}>
              <Link
                className={clsx(styles.getStartedButton, "inline-flex rounded-lg px-5 py-2.5 font-semibold text-white")}
              ...
              <a
                className={clsx(styles.contributeButton, "inline-flex rounded-lg border px-5 py-2.5 font-semibold")}
          ...
          <div className="container mx-auto max-w-6xl px-4">
            <div className={styles.ctaContent}>
              ...
              <div className={styles.ctaButtons}>
                <a
                  className="inline-flex rounded-lg px-5 py-2.5 font-semibold text-white"
                  style={{ background: "#0f766e" }}
                ...
                <Link
                  className="inline-flex rounded-lg border border-slate-300 bg-white px-5 py-2.5 font-semibold"
                  href="/fellowship"
                >
                  AI Fellowship
                </Link>
