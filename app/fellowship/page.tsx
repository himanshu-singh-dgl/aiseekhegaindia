        ...
        <div className={styles.contentSection}>
          <div className={styles.introSection}>
            ...
            <p className={styles.introText}>
              <strong>Lex AI Technologies Private Limited</strong> is the
              holding company behind <strong>AI Seekhega India</strong>,
              dedicated to democratizing AI education and empowering India&apos;s
              workforce with cutting-edge AI skills. Our flagship program, the{' '}
          ...
          <div className={styles.programsSection}>
            ...
            <div className={styles.programCard}>
              ...
              <p className={styles.programValue}>
                ...
                Machine Learning Engineers and Applied Scientists at leading
                tech firms.
              </p>
              ...
              <div className={styles.learningOutcomes}>
                ...
                <ul className={styles.outcomesList}>
                  ...
                  <li>
                    <span className={styles.outcomeIcon}>📊</span>
                    <strong>Maths for AI</strong> - Linear Algebra, Probability,
                    Stats, Calculus
                  </li>
                  <li>
                    <span className={styles.outcomeIcon}>🔧</span>
                    <strong>Applied ML &amp; DL</strong> with real-world case
                    studies
                  </li>
                  <li>
                    <span className={styles.outcomeIcon}>🚀</span>
              ...
              <div className={styles.programCta}>
                <a
                  href="https://www.lexailabs.com/ai-fellowship"
                  className={clsx(styles.button, styles.programButton)}
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className={styles.programCard}>
              ...
              <div className={styles.learningOutcomes}>
                ...
                <ul className={styles.outcomesList}>
                  <li>
                    <span className={styles.outcomeIcon}>🧠</span>
                    <strong>Deep AI Understanding</strong> → How AI systems are
                    designed &amp; work at a conceptual level
                  </li>
                  <li>
                    <span className={styles.outcomeIcon}>⚡</span>
                    <strong>Productivity Mastery</strong> → Using AI tools for
                    leadership workflows
                  </li>
                  <li>
                    <span className={styles.outcomeIcon}>🎯</span>
                    <strong>Agent Opportunities</strong> → Spot AI-agent
                    opportunities inside teams
                  </li>
                  <li>
                    <span className={styles.outcomeIcon}>📋</span>
                    <strong>Custom Playbook</strong> → Industry-specific AI
                    adoption playbook
                  </li>
                </ul>
              </div>
