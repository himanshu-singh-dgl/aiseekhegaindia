          ...
          <div className={styles.contentSection}>
            <div className={styles.introSection}>
              ...
              <p className={styles.introText}>
                ...
                empowering India&apos;s workforce with cutting-edge AI skills. Our flagship program,
                the <strong>Lex AI Fellowship</strong>, offers specialized tracks designed for
            ...
            <div className={styles.programsSection}>
              ...
              <div className={styles.programCard}>
                ...
                <p className={styles.programValue}>
                  A program that helps leaders understand, apply, and drive AI adoption inside
                  their organizations.
                </p>
                ...
                <div className={styles.learningOutcomes}>
                  ...
                  <ul className={styles.outcomesList}>
                    <li>
                      <span className={styles.outcomeIcon}>🧠</span>
                      <strong>Deep AI Understanding</strong> → How AI systems are designed & work
                      at a conceptual level
                    </li>
                    <li>
                      <span className={styles.outcomeIcon}>⚡</span>
                      <strong>Productivity Mastery</strong> → Using AI tools for leadership
                      workflows
                    </li>
                    <li>
                      <span className={styles.outcomeIcon}>🎯</span>
                      <strong>Agent Opportunities</strong> → Spot AI-agent opportunities inside
                      teams
                    </li>
                    <li>
                      <span className={styles.outcomeIcon}>📋</span>
            ...
            <div className={styles.finalCtaSection}>
              ...
              <p className={styles.ctaSubtitle}>
                Join thousands of professionals who have accelerated their careers through Lex AI
                Fellowship
              </p>
