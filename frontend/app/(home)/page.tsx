          ...
          <div className={styles.heroContent}>
            <div className={styles.heroLeft}>
              <h1 className={styles.heroTitle}>
                Building India&apos;s{' '}
                <span className={styles.heroTitleHighlight}>AI</span> Future
                Together
              </h1>
        ...
        <section className={styles.ctaSection}>
          <div className="container mx-auto max-w-6xl px-4">
            <div className={styles.ctaContent}>
              ...
              <p>
                Contribute to the platform, share your expertise, and help build
                a comprehensive resource for AI and ML practitioners around the
                world.
              </p>
              <div className={styles.ctaButtons}>
                <Link className={styles.getStartedButton} href="/contribute">
