...
import { generateBinaryData, sigmoid, splitData, calculateAccuracy } from './utils/math';
...
interface HistoryPoint extends TrainingState {
...
const TrainingSection: React.FC = () => {
  ...
  const [trainingHistory, setTrainingHistory] = useState<HistoryPoint[]>([]);
